...
@testset "Likelihood tests" begin
    ...
    negative_parameter_1 = ModelParameters(10000.0,5.0,log(2)/30,log(2)/90,-1.0,1.0,29.0);
    negative_parameter_2 = ModelParameters(-10000.0,5.0,log(2)/30,log(2)/90,1.0,1.0,29.0);
